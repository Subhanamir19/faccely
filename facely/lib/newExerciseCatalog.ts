...
export const NEW_EXERCISE_CATALOG: NewExerciseCatalogEntry[] = [
  ...
  },
  {
    ...
    source: [
      require("../assets/new-exercises-videos/chin-tucks-pose1.jpg"),
      require("../assets/new-exercises-videos/chin-tucks-pose2.jpg"),
    ],
  ...
  },
  {
    ...
    source: [
      require("../assets/new-exercises-videos/FISH-FACE-POSE1.jpg"),
      require("../assets/new-exercises-videos/FISH-FACE-POSE2.jpg"),
    ],
    mediaType: "imageSequence",
    guideId: "fish-face",
  ...
  },
  {
    ...
    title: "Mewing",
    fileName: "mewing.png",
    source: require("../assets/new-exercises-videos/mewing.jpg"),
    mediaType: "image",
    guideId: "mewing",
  ...
  },
  {
    ...
    source: require("../assets/new-exercises-videos/midface-lift.jpg"),
    mediaType: "image",
