...
export const EXERCISE_GUIDES: Record<string, ExerciseGuide> = {
  ...
  lion: {
    ...
    name: "Lion Face",
    holdTime: "5 seconds",
    reps: "10 reps, or 3 sets of 20-25 reps",
    frequency: "Daily",
    howTo: [
      "Take a deep breath in through your nose",
      "Open your mouth as wide as possible",
      "Stick your tongue out and down toward your chin",
      "Widen your eyes",
      "Exhale forcefully while holding the pose",
    ],
    tips: [
      "Make it dramatic - really stretch everything",
      "Great for releasing facial tension",
      "Can be done as part of face yoga routine",
    ],
  },
};
