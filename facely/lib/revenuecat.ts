...
export async function checkSubscriptionStatus(): Promise<boolean> {
  try {
    ...
    logger.log("[RevenueCat] Subscription status:", {
      hasEntitlement,
    ...
    logger.error("[RevenueCat] Failed to check subscription status:", error);
...
export async function getOfferings(): Promise<PurchasesOfferings | null> {
  try {
    ...
    logger.log("[RevenueCat] Fetched offerings:", {
...
export async function identifyUser(newAppUserId: string): Promise<void> {
  try {
    ...
    logger.log("[RevenueCat] User identified:", newAppUserId);
  } catch (error) {
